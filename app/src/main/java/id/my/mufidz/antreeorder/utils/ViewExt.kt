...
fun NavOptionsBuilder.slideRightLeftAnim() {
    anim {
    ...
    val snackbar = Snackbar.make(this, message, Snackbar.LENGTH_LONG)
        .apply {
            if (isError) {
                ...
                setActionTextColor(ContextCompat.getColor(context, android.R.color.holo_red_dark))
            }
...
fun TextInputLayout.setErrorNot(isError: Boolean = true, errorMsg: String = "Tidak boleh kosong") {
